    ...
    <div id="container">
        <div id="left">
            <div class="box1">
                <div class="left-box">
                    <div class="poster">
                        <img src="img/films/homepage_image/forrest_gump.webp">
                    </div>
                    <div class="info">
                        <h3>Forrest Gump</h3>
                        <p>Duration : 1h30</p>
                ...
                <div class="right-box">
                    ...
                    <button class="deleteButton">
                        <img src="img/icons/trash.webp" id="trash">
            ...
            <div id="box2">
                ...
                <div class="card-form">
                    <form action="/submit_registration" method="post">
                        ...
                        <div id="exp-cvc">
                            <div id="exp">
                                <label for="experiation-date">Expiration Date</label>
                                <input type="text" id="experiation-date" name="experiation-date" required placeholder="Enter the date...">
                            </div>
